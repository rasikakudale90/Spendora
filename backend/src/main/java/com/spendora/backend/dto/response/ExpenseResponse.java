...
public class ExpenseResponse {
    ...
    public ExpenseResponse(UUID id, String title, BigDecimal amount, ExpenseCategory category, LocalDate expenseDate, String description, OffsetDateTime createdAt, OffsetDateTime updatedAt) {
        this.id = id;
        this.title = title;
        this.amount = amount;
    ...
    public static class Builder {
        ...
        public ExpenseResponse build() {
            return new ExpenseResponse(id, title, amount, category, expenseDate, description, createdAt, updatedAt);
        }
    }
}
