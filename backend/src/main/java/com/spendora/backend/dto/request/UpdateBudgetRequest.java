...
public class UpdateBudgetRequest {
    ...
    public UpdateBudgetRequest(String name, ExpenseCategory category, LocalDate periodStart, LocalDate periodEnd, BigDecimal limitAmount) {
        this.name = name;
    ...
    public static class Builder {
        ...
        public UpdateBudgetRequest build() {
            return new UpdateBudgetRequest(name, category, periodStart, periodEnd, limitAmount);
        }
    }
}
